...
# Note: This script has examples of 
## 			- linux shell tools for file manipulation and looping
## 			- a conda environment with samtools and freebayes
##			- a singularity container with minimap2
##			- clean-up steps to prevent running out of space in the /scratch env
##			- using requested resources (eg threads/cpus-per-task)
...
# checking new file exists and isn't empty before deleting old files
